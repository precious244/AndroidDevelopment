...
import My.practice.activity.NewsDetailActivity
...
import My.practice.databinding.FragmentNewsBinding
 ...
 */
@AndroidEntryPoint
class NewsFragment : Fragment(), NewsAdapter.NewsSelectedCallBack {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewMOdel.getRandomNews("ec20546f98434fdda1b5bf65bd65ee76")
        setObserver()
    }

    private fun setObserver() {
        viewMOdel.getRandomNewsLiveData().observe(
